...
const universityApplicationProcessReducer = createAsyncThunk('universityApplicationProcess/universityApplicationProcessReducer',
  async (data)=>{
    return axios.get(`https://sigma-lpu-vsbd9.ondigitalocean.app/api/v2/university/extra/applications/${data?.id}`,{
        headers: {
...
const universityApplicationProcessAddReducer = createAsyncThunk('universityRecentUpdate/universityApplicationProcessAddReducer',
  async (data)=>{
    var config = {
      method: 'post',
      url: `https://sigma-lpu-vsbd9.ondigitalocean.app/api/v2/university/extra/applications/${data?.id}/add`,
      headers: { 
        'Content-Type': 'application/json',
          Authorization : "Bearer "+localStorage.getItem('token')
      },
