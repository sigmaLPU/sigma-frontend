...
import Card, {ObjectCard,FileCard,ContactCard,RecentUpdateCard,ModalPopUp} from './common_components/card'
// chip 
...
export {
	...
	// componets
	NavSideBarLayout,
	Card, ObjectCard,FileCard,ContactCard,RecentUpdateCard,ModalPopUp,
	Chip,
	Table,	
