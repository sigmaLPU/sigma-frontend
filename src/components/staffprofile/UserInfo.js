      ...
      <div className="card">
        ...
        <div className="user-info" >
          ...
          <p style={{display: 'flex', alignItems: 'center', margin:'10px'}}>
                ...
                <span className='value' style={{width: '50%'}}>63682</span>
              </p>
              <p style={{display: 'flex', alignItems: 'center', margin:'10px'}}>
                <span className='leftdata' style={{width: '40%'}}>Nationality</span>
                
                 <span className="colon" style={{width: '10%'}}>:</span>
                <span  className='value' style={{width: '50%'}}> Indian</span>
              </p>
              <p style={{display: 'flex', alignItems: 'center', margin:'10px'}}>
                <span className='leftdata' style={{width: '40%'}}>Gender</span>
                
                 <span className="colon" style={{width: '10%'}}>:</span>
                <span className='value' style={{width: '50%'}}> Male</span>
              </p>
              <p style={{display: 'flex', alignItems: 'center', margin:'10px'}}>
                <span className='leftdata' style={{width: '40%'}}>D.O.B</span>
                
                 <span className="colon" style={{width: '10%'}}>:</span>
                <span className='value' style={{width: '50%'}}> 21-12-2002</span>
              </p>
              <p style={{display: 'flex', alignItems: 'center', margin:'10px'}}>
            ...
            <p style={{display: 'flex', alignItems: 'center' , margin:'10px'}}>
              ...
              <p style={{display: 'flex', alignItems: 'center', margin:'10px'}}>
                <span className='leftdata' style={{width: '70%'}}>Phone Model</span>
                 ...
                 <span className="colon" style={{width: '10%'}}>:</span>
                <span className='value' style={{width: '50%'}}>POCO X2</span>
              </p>
              <p style={{display: 'flex', alignItems: 'center', margin:'10px'}}>
              ...
              <p style={{display: 'flex', alignItems: 'center', margin:'10px'}}>
                ...
                <span className='value' style={{width: '0%'}}> Aakashaman9931@gmail.com</span>
              </p>
